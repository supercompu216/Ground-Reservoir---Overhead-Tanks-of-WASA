...
map.getView().fit([7411598.150235, 3486235.211926, 7557415.594250, 3570085.489835], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Ground Reservoirs & Overhead Tanks of QWAS</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (150 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Please Inform if there is any change in any Ground Reservoir and Overhead Tank <br />(How to Use)<br />Click on any Reservoir or Tank and see the detail of it<br /> ';
            }
